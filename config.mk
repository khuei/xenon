...
LTO=-fdevirtualize-at-ltrans -flto -fuse-linker-plugin -fno-semantic-interposition
...
CFLAGS=$(MFLAGS) $(CPPFLAGS) $(WARNFLAGS) $(GCCFLAGS) $(LTO) --std=gnu11
CXXFLAGS=$(MFLAGS) $(CPPFLAGS) $(WARNFLAGS) $(GCCFLAGS) $(LTO) --std=gnu++17
LDFLAGS=$(MFLAGS) $(WARNFLAGS) -nostdlib $(GCCFLAGS) $(LTO)
SIZEFLAGS=-d --common
