...
std::shared_ptr<okapi::IMU> imu =
	std::make_shared<okapi::IMU>(16, okapi::IMUAxes::z);
...
std::shared_ptr<okapi::Logger> okapi_logger = std::make_shared<okapi::Logger>(
	okapi::TimeUtilFactory::createDefault().getTimer(),
	logger::logfile(),
	okapi::Logger::LogLevel::debug);

std::shared_ptr<okapi::Motor> front_left = std::make_shared<okapi::Motor>(
	1,
	false,
	okapi::AbstractMotor::gearset::green,
	okapi::AbstractMotor::encoderUnits::degrees,
	okapi::Logger::getDefaultLogger());
std::shared_ptr<okapi::Motor> back_left = std::make_shared<okapi::Motor>(
	11,
	false,
	okapi::AbstractMotor::gearset::green,
	okapi::AbstractMotor::encoderUnits::degrees,
	okapi::Logger::getDefaultLogger());
std::shared_ptr<okapi::Motor> front_right = std::make_shared<okapi::Motor>(
	10,
	true,
	okapi::AbstractMotor::gearset::green,
	okapi::AbstractMotor::encoderUnits::degrees,
	okapi::Logger::getDefaultLogger());
std::shared_ptr<okapi::Motor> back_right = std::make_shared<okapi::Motor>(
	20,
	true,
	okapi::AbstractMotor::gearset::green,
	okapi::AbstractMotor::encoderUnits::degrees,
...
std::shared_ptr<okapi::Motor> top_intake = std::make_shared<okapi::Motor>(
	8,
	false,
	okapi::AbstractMotor::gearset::green,
	okapi::AbstractMotor::encoderUnits::degrees,
	okapi::Logger::getDefaultLogger());
std::shared_ptr<okapi::Motor> bottom_intake = std::make_shared<okapi::Motor>(
	2,
	false,
	okapi::AbstractMotor::gearset::green,
	okapi::AbstractMotor::encoderUnits::degrees,
...
std::shared_ptr<okapi::Motor> left_intake = std::make_shared<okapi::Motor>(
	12,
	false,
	okapi::AbstractMotor::gearset::green,
	okapi::AbstractMotor::encoderUnits::degrees,
	okapi::Logger::getDefaultLogger());
std::shared_ptr<okapi::Motor> right_intake = std::make_shared<okapi::Motor>(
	19,
	true,
	okapi::AbstractMotor::gearset::green,
	okapi::AbstractMotor::encoderUnits::degrees,
...
std::shared_ptr<okapi::ChassisController> internal_intake =
	okapi::ChassisControllerBuilder()
		...
		.withDimensions(okapi::AbstractMotor::gearset::green,
				{ { chassis::distance_constant,
				    chassis::turn_constant },
				  okapi::imev5GreenTPR })
...
std::shared_ptr<okapi::SkidSteerModel> internal_model =
	std::dynamic_pointer_cast<okapi::SkidSteerModel>(
		internal_intake->getModel());
std::shared_ptr<okapi::SkidSteerModel> front_model =
	std::dynamic_pointer_cast<okapi::SkidSteerModel>(
		front_intake->getModel());
